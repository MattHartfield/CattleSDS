...
do
	...
	bedtools intersect -a sigsds_${fname}N0.bed -b Bos_taurus.ARS-UCD1.2.104.gtf -wb > SigSDSAnnotate_${fname}N0.dat
	...
	paste -d ,, SigSDSGenes_${fname}N0P1.dat SigSDSGenes_${fname}N0P2.dat > OutTables/SigSDSGenesProteinCoding_${fname}N0.csv
