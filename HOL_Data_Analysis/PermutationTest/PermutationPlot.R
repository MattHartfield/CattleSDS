...
tpvt1 <- data.frame(N0=c("HighN0","LowN0"),plab=paste0("P-value = ", c(PmfpH, PmfpL)),x=20,y=60)
...
tpvt2 <- data.frame(N0=c("HighN0","LowN0"),plab=paste0("P-value = ", c(PmppH, PmppL)),x=10,y=57.5)
...
tpvt3 <- data.frame(N0=c("HighN0","LowN0"),plab=paste0("P-value = ", c(Ps6pH, Ps6pL)),x=10,y=75)
...
tpvt4 <- data.frame(N0=c("HighN0","LowN0"),plab=paste0("P-value = ", c(Ps5pH, Ps5pL)),x=12.5,y=75)
