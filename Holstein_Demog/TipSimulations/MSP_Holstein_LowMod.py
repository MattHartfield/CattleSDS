...
# Changed recent No to 49

# Update 21st Jan 2019
# Using actual data files provided by Simon Boitard (for other pop size estimates)
...
def holstein_demog(n,reps):
	...
	# THIS VERSION REDUCES N0 TO 49 (pedigree-based estimates are lower; see Sorensen et al 2005)
	N_0 = 49
	N_1 = 1077
	N_2 = 1320
	N_3 = 1815
